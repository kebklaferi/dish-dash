...
namespace DeliveryService.Logging;
...
public class CorrelationLogger
{
    ...
    public void LogInfo(string message, object? data = null)
    {
        ...
        var logMessage = $"{DateTime.UtcNow:yyyy-MM-dd HH:mm:ss,fff} INFO {url} Correlation: {correlationId} [DeliveryService] - {message}";
    ...
    public void LogError(string message, Exception? ex = null, object? data = null)
    {
        ...
        var logMessage = $"{DateTime.UtcNow:yyyy-MM-dd HH:mm:ss,fff} ERROR {url} Correlation: {correlationId} [DeliveryService] - {message}";
    ...
    public void LogWarning(string message, object? data = null)
    {
        ...
        var logMessage = $"{DateTime.UtcNow:yyyy-MM-dd HH:mm:ss,fff} WARN {url} Correlation: {correlationId} [DeliveryService] - {message}";
